...
<div id="featured" class="flexslider<?php echo $featured_slider_class; ?>">
	...
	<?php
		...
		<!--<li class="slide">					
				<a href="http://www.gmic-sv.com/" target="_blank">							
					<img src="http://cn.gmic-bj.com/wp-content/themes/gmic/images/GMICSV-slide.jpg" alt="GMIC SV" width="960px" height="360px"></a>
			</li>-->
		<!--<li class="slide">					
